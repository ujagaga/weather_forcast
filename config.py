...
WEATHER_CODES = {
    0: {"en": "Clear sky", "sr": "Vedro", "ru": "Чистое небо", "icon": "c01"},
    ...
    3: {"en": "Overcast", "sr": "Oblačno", "ru": "Пасмурная погода", "icon": "c04"},
    45: {"en": "Fog", "sr": "Magla", "ru": "Туман", "icon": "a01"},
    48: {"en": "Depositing rime fog", "sr": "Taloženje magle", "ru": "Депонирование изморози туман", "icon": "a01"},
    ...
    65: {"en": "Heavy rain", "sr": "Jaka kiša", "ru": "Ливень", "icon": "r01"},
    ...
    71: {"en": "Slight snow", "sr": "Slab sneg", "ru": "Слабый снег", "icon": "s01"},
    73: {"en": "Moderate snow", "sr": "Umeren sneg", "ru": "Умеренный снег", "icon": "s01"},
    75: {"en": "Heavy snow", "sr": "Gust sneg", "ru": "Сильный снегопад", "icon": "s01"},
    77: {"en": "Snow grains", "sr": "Ledeni sneg", "ru": "Снежные зерна", "icon": "s01"},
    80: {"en": "Slight rain showers", "sr": "Laki pljuskovi", "ru": "Слабые дожди", "icon": "r01"},
    ...
    85: {"en": "Slight snow showers", "sr": "Slab sneg", "ru": "Слабый снег", "icon": "s01"},
    86: {"en": "Heavy snow showers", "sr": "Jak sneg", "ru": "Сильный снегопад", "icon": "s01"},
